...
$Sql = "SELECT a.CompanyCode, a.ServiceType, c.Category1, c.Category2, c.ContentsName, c.LectureCode,
...
WHERE b.CompanyCode='$CompanyCode' AND a.ServiceType IN (1,3,5,9) AND a.LectureStart='$LectureStart' AND a.LectureEnd='$LectureEnd' and a.LectureCode='$LectureCode'";
$Result = mysqli_query($connect, $Sql);
$Row = mysqli_fetch_array($Result);
    	...
    	<div class="popupArea">
            ...
            <div class="infoArea">
            	...
            	<div class="managerTxt">
                    ...
                    <p>
						<span><em>수료인원: </em><?=$StudyCount?>명 / <em>전체인원: </em><?=$StudySum?>명</span>
                    </p>
