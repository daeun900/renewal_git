	...
	<table border="0">
		...
		<tr>
			<td colspan="2" class="info" align="center">
				<div class="input-div">
					<span><input type="text" id="otpNo" placeholder="인증번호" maxlength="6" autocomplete="off" numberOnly="true" style="font-size:14px; font-weight:bold; padding:0 10px; width: 100px; height:30px; vertical-align:top; -webkit-border-radius:4px; -moz-border-radius:4px; border-radius:4px;    border: solid 1px #d5d5d5;" /></span>
		...
		<tr>
			<td colspan="2" class="info" align="center" style="padding: 10px 0 10px 0">
				<img src="img/motp_sample_img.png" alt="sample_motp_img" style="width:100%">
			</td>
		</tr>
	</table>
</div>
