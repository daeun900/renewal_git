...
$Manager_Top_Link_array = array(
    ...
    "E6" => "study_end.php", //수강마감
    "E7" => "study_payment.php", //결제관리
    ...
    //FLEX
    "G1" => "course_cyber.php", //단과컨텐츠관리
    "G2" => "study2.php", //학습관리
    "G3" => "study_correct2.php", //첨삭관리
    "G4" => "study_end.php", //수강마감
    "G5" => "study2_payment.php", //결제관리
